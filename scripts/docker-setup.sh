...
echo -e ""
echo -e "3. ${BLUE}Setup Nginx reverse proxy${NC}"
echo -e "   (Xem hướng dẫn trong SETUP_DOCKER_139.180.221.202.md)"
echo -e ""
echo -e "4. ${BLUE}Setup SSL với Let's Encrypt${NC}"
echo -e "   ${GREEN}certbot --nginx -d tradingview.com.vn${NC}"
echo -e ""
